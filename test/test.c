...
char *assert(List_ptr list, char msg[], int result, int count, int expected_list_values[])
{
  char *sign = "✅ ";
  int counter = 0;
...
void add_to_end_in_empty_list(List_ptr list)
{
  ...
  char *sign = assert(list, msg, result, 1, expected_values);
  printf("%s %s", sign, msg);
}
...
void add_to_end_in_list_of_1_number(List_ptr list)
{
  ...
  char *sign = assert(list, msg, result, 2, expected_values);
  printf("%s %s", sign, msg);
}
...
void add_to_end_in_list_of_having_more_than_one_numbers(List_ptr list)
{
  ...
  char *sign = assert(list, msg, result, 3, expected_values);
  printf("%s %s", sign, msg);
}
...
void insert_at_the_last_position_of_list(List_ptr list)
{
  ...
  char *sign = assert(list, msg, result, 4, expected_values);
  printf("%s %s", sign, msg);
}
